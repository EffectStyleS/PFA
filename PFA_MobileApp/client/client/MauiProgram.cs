...
{
    private const string BaseUrl = "https://2b4c-94-25-227-199.ngrok-free.app";
    ...
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddTransient<IncomesStatisticsPage>();
        builder.Services.AddTransient<IncomesStatisticsViewModel>();
        ...
        builder.Services.AddTransient<ExpensesStatisticsPage>();
        builder.Services.AddTransient<ExpensesStatisticsViewModel>();
        ...
        builder.Services.AddTransient<GoalsStatisticsPage>();
        builder.Services.AddTransient<GoalsStatisticsViewModel>();
