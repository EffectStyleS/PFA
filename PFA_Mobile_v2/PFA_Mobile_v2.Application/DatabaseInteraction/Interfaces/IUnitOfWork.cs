...
/// <summary>
/// Интерфейс для реализации паттерна UnitOfWork для работы репозиториев с одним контекстом данных
/// </summary>
public interface IUnitOfWork
{
    ...
    /// </summary>
    /// <returns>
    /// При успешном выполнении возвращает количество записей состояния, записанных в базу данных.
